...
public:
    ...
    string show() {
        return ((RemoveTrailingZeros(to_string(A))) + "*x^2 = 0");
    }
};
...
public:
    ...
    string  Get_answer_podbor() {
        if ((((-1) * C) / A) < 0) {
            ...
            return ("Методом подбора один из корней уравнения: " + RemoveTrailingZeros(to_string(x)));
        }
    }

    string show() {
        return (RemoveTrailingZeros(to_string(A)) + "*x^2 + " + RemoveTrailingZeros(to_string(C)) + " = 0");
    }
};
...
public:
    ...
    string show() {
        return  (RemoveTrailingZeros(to_string(B)) + "*x + " + RemoveTrailingZeros(to_string(C)) + " = 0");
    }
};
...
public:
    ...
    string show() {
        return (RemoveTrailingZeros(to_string(A)) + "*x^2 + " + RemoveTrailingZeros(to_string(B)) + "*x + " + RemoveTrailingZeros(to_string(C)) + " = 0");
    }
};
...
public:
    ...
    string show() {
        return (RemoveTrailingZeros(to_string(B)) + "*x = 0");
    }
...
public:
    ...
    string show() {
        return (RemoveTrailingZeros(to_string(A)) + "*x^2 + " + RemoveTrailingZeros(to_string(B)) + "*x = 0 ");
    }
};
